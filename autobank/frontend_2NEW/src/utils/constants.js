...
export const NAV_SECTIONS = [
  ...
  },
  {
    label: "Smart Planner",
    items: [
      { label: "Salary & Expenses", to: "/planner", icon: "Calculator" },
      { label: "Invest My Savings", to: "/planner/invest", icon: "TrendingUp" },
      { label: "Loan Advisor", to: "/planner/loan-advisor", icon: "BadgeIndianRupee" },
      { label: "No-Income Tracker", to: "/planner/survival-tracker", icon: "ShieldAlert" },
    ],
  },
  {
    label: "Support",
