...
import SmartPlanner from "../pages/planner/SmartPlanner.jsx";
import InvestMySavings from "../pages/planner/InvestMySavings.jsx";
import LoanAdvisor from "../pages/planner/LoanAdvisor.jsx";
import SurvivalTracker from "../pages/planner/SurvivalTracker.jsx";
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
        ...
        <Route path="/planner/invest" element={<InvestMySavings />} />
        <Route path="/planner/loan-advisor" element={<LoanAdvisor />} />
        <Route path="/planner/survival-tracker" element={<SurvivalTracker />} />
